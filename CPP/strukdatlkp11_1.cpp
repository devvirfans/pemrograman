    ...
    while (1)
        {
            ...
            cout<<"1. Menampilkan tree"<<endl;
            cout<<"2. Melakukan penghapusan node"<<endl;
            cout<<"3. Melakukan penyisipan node"<<endl;
            cout<<"4. Exit"<<endl;
            cout<<"||****************************||"<<endl;
            ...
            case 1:
                cout<<"	"<<endl;
                bst.fun_4(root,1); cout<<endl;
                break; 
            case 2:
            if (root ==  NULL){ 
                cout<<"Tree kosong"<<endl; 
                continue;}
            cout<<"Ketik angka node yang ingin dihapus dari tree: ";
            cin>>num; 
            bst.fun_2(num); 
            break;
        case 3:
            temp = new node;
            cout<<"Ketik angka node yang akan dilakukan penyisipan: ";
            cin>>temp->info; 
            bst.fun_3(root, temp); 
            break;
        case 4:
...
void BST::fun_2(int item)
{
    ...
    if (root == NULL)
    {
        cout<<"Tree dalam keadaan empty"<<endl; return;
    }
